    ...
    <>
      <ProtectedRoute allowedRoles={['admin']}>
        <Heading 
          ...
          description="View detailed session history and outcomes"
          keywords="admin, sessions, counseling history, session outcomes"
        />
              ...
              <div className="p-6 lg:p-8 rounded-xl lg:rounded-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl shadow-gray-900/10">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mt-2">
                    Track and analyze completed counseling sessions
                  </p>
                </div>
                <SessionsList />
              </div>
