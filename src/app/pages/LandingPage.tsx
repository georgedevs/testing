        ...
        >
          ...
          >
            <motion.h1 
              ...
              className="mb-4 md:mb-6 text-3xl md:text-6xl font-bold text-center bg-gradient-to-r from-purple-600 to-orange-500 dark:from-orange-400 dark:to-purple-500 bg-clip-text text-transparent leading-tight"
            >
